...
- Anthropic: `Claude 4.6 Opus`, `Claude 4.5 Sonnet`, `Claude 4.5 Haiku` (all with or without Thinking)
- Google: `Gemini 3 Pro Preview`, `Gemini 3 Flash Preview`
- DeepSeek: `DeepSeek Chat V3.2`, `DeepSeek Reasoner V3.2`
- Mistral: `Mistral Large 3`, `Mistral Medium 3.1`, `Magistral Medium 1.1 (Thinking)`
