...
const MODELS = [
  'Claude 5.5 Opus', 'GPT-5.5', 'Gemini Flash 3.5', 'DeepSeek V4 Pro',
  ...
  return (
    <div className="w-full max-w-[1040px] mx-auto px-4 sm:px-7 flex flex-col">
      ...
      <footer className="border-t border-[var(--line-1)] pt-9 pb-12 flex flex-col items-center gap-[18px]">
        ...
        <p className="m-0 max-w-[60ch] text-center text-[12px] text-[var(--fg-3)] leading-[1.55]">
          Every character, portrait and voice here is generated by AI as you play. No third-party
          copyrighted assets are used — see the{" "}
          <Link href="/terms" className="underline underline-offset-2 hover:text-[var(--fg-1)] transition-colors duration-[120ms]">Terms</Link>.
        </p>
