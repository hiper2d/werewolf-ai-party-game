...
export default function PrivacyPolicy() {
  return (
    <article className="content-doc">
      ...
      <ul className="doc-list">
        <li><b>Firebase (Google Cloud):</b> Stores all application data — user accounts and games.
        ...
        <li><b>AI providers (OpenAI, Anthropic, Google, etc.):</b> Game messages are sent to AI providers
          to generate bot responses. All tiers run on our own provider accounts — you never supply
          API keys.</li>
